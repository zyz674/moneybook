...
| | 📱 安卓 App | 🔗 纯前端版（点开就用） | 🖥 服务端版 |
| --- | --- | --- | --- |
| 怎么用 | 下载 APK 装上 | **<https://zyz674.github.io/moneybook/>** | 自己电脑 / 服务器 / Termux 跑起来 |
| 自动抓微信支付宝流水 | ✅ 通知一进来就记 | ❌ | ✅ |
| 每天定时出账单 | ✅ 手机本地弹通知 | ❌ 页面开着才提醒 | ✅ 推到微信/Bark |
| **需要常开的机器** | **不需要** | 不需要 | 需要 |
| 数据在哪 | 手机里 | 浏览器里 | 你的电脑上 |
...
### 方式 A：安卓 App（最省事，不用电脑）

到 [Actions](https://github.com/zyz674/moneybook/actions/workflows/android.yml) 下载最新 APK 装上，
开启「通知读取权限」即可：付款通知自动记账，每天定点在手机上弹账单，数据只存在手机里。
